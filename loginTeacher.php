...
if(isset($_POST['btn-login-teacher'])){

  $input_user = $_POST['txt_user'];
  $input_pass = $_POST['txt_pass'];

  $sql = "select * from tbl_teacher where Email = '$input_user' and Password = '$input_pass'";
...
<form action="loginTeacher.php" method="post">
  ...
  <input type="text" class="form-control" placeholder="Enter Email" name="txt_user" required>
  <br>
  <label>Password:</label>
  <input type="password" class="form-control" placeholder="Enter Password" name="txt_pass" required>
  <br>
  <button type="submit" name="btn-login-teacher" class="btn btn-success form-control" name="button">LOGIN</button>
</form>
</div>
