...
if(isset($_POST['btn-login'])){
  ...
  $sql = "select * from tbl_student where Student_ID = '$input_user' and DOB = '$input_pass'";
...
<form action="login.php" method="post">
  ...
  <input type="text" class="form-control" placeholder="Enter Roll Number" name="txt_user" required>
  <br>
  <label>Password:</label>
  <input type="password" class="form-control" placeholder="yyyy-mm-dd" name="txt_pass" required>
  <br>
